<template>
    <div>
        <nav class="navbar navbar-toggleable-md navbar-inverse sticky-top">
            <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarTogglerSaves" aria-controls="navbarTogglerSaves" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <a class="navbar-brand logo" href="#"><span class="p-1">SAVES</span></a>

            <div class="collapse navbar-collapse" id="navbarTogglerSaves">
                <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                    <li class="nav-item active">
                        <router-link class="nav-link" to="/files/list">文件列表<span class="sr-only">(current)</span></router-link>
                    </li>
                    <li class="nav-item">
